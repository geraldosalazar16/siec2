...
$ID = $objeto->ID;
valida_parametro_and_die($ID, "Falta id de domicilio");
...
$total_con_fiscal = $database->count("CLIENTES_DOMICILIOS", "*", ["AND"=>["ID_CLIENTE"=>$ID_CLIENTE, "ES_FISCAL"=>"si", "ID[!]"=>$ID]]);
...
$id = $database->update("CLIENTES_DOMICILIOS", [
...
$respuesta['mensaje']="se ha actualizado el domicilio";
