...
/*==========================================================================================*/
/*	Y1  => AUDITORIAS DE RENOVACION PROGRAMADAS Y QUE CUMPLEN LA REGLA DE LOS 30 DIAS.		*/
/*	Y2  => AUDITORIAS DE RENOVACION PROGRAMADAS Y QUE NO CUMPLEN LA REGLA DE LOS 30 DIAS.	*/
/*==========================================================================================*/
$respuesta=array(); 
$datos1= array();
//Constantes
...
//INICIALIZANDO VARIABLES
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."01%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."02%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."03%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."04%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."05%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."06%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."07%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."08%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."09%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."10%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."11%' ORDER BY `IPOR`.`ID` DESC";
	...
	$consulta = "SELECT `IPOR`.`CANT_AUD_PROG_A_TIEMPO`,`IPOR`.`CANT_AUD_PROG_F_TIEMPO`
						...
						FROM `I_PROGRAMACIONES_OPORTUNAS_RENOVACION_SG` `IPOR`
						WHERE 
							`IPOR`.`FECHA` LIKE '".$ano_curso."12%' ORDER BY `IPOR`.`ID` DESC";
