<?php
	...
	"[>]USUARIOS" => ["ID_USUARIO_SECUNDARIO" => "ID"]];
	...
	"user_modificacion.NOMBRE(USUARIO_MODIFICACION)","USUARIOS.NOMBRE(USUARIO_SECUNDARIO)","PROSPECTO.ID_USUARIO_SECUNDARIO","PROSPECTO.ID_USUARIO_PRINCIPAL" ];
	$id = $_REQUEST["id"]; 
