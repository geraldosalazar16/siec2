<?php
	...
	"user_modificacion.NOMBRE(USUARIO_MODIFICACION)","p_porcentaje.PORCENTAJE(PORCENTAJE)","p_porcentaje.ID(ID_PORCENTAJE)","PROSPECTO.ID_USUARIO_PRINCIPAL","PROSPECTO.ID_USUARIO_SECUNDARIO","PROSPECTO.TIPO_PERSONA"];
	$id = $_REQUEST["id"]; 
