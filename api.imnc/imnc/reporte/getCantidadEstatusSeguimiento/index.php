<?php 
	...
	if(isset($_REQUEST["usuario"])){
		...
		$query = "SELECT P.ID,  IFNULL(COUNT(IF(P.USUARIO_CREACION = '".$id_usuario."',P.ID,NULL)), 0) AS CONTADOR,PES.ESTATUS_SEGUIMIENTO,P.USUARIO_CREACION
 FROM PROSPECTO_ESTATUS_SEGUIMIENTO AS PES
LEFT JOIN PROSPECTO AS P ON P.ID_ESTATUS_SEGUIMIENTO = PES.ID
GROUP BY PES.ID,P.USUARIO_CREACION";
	}else{
