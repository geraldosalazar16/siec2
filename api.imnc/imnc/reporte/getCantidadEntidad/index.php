<?php 
	...
	if(isset($_REQUEST["usuario"])){
		...
		$query = "SELECT ENTIDAD_FEDERATIVA,PD.COLONIA,IFNULL(COUNT(IF(PD.USUARIO_CREACION = '".$id_usuario."' ,PD.COLONIA,NULL)), 0) AS CONTADOR,PD.USUARIO_CREACION
...
GROUP BY TEF.ENTIDAD_FEDERATIVA,PD.USUARIO_CREACION";
	}else{
