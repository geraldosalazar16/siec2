...
$cotizacio_tramite = $database->get("COTIZACIONES_TRAMITES_HM", "*", ["ID"=>$id]); 
valida_error_medoo_and_die(); 
...
$cantidad_de_sitios = $database->count("COTIZACION_SITIOS_HM", ["ID_COTIZACION"=>$cotizacio_tramite["ID"]]);
valida_error_medoo_and_die(); 



$campos = [
	"COTIZACION_SITIOS_HM.ID",
	"COTIZACION_SITIOS_HM.ID_COTIZACION",
	"COTIZACION_SITIOS_HM.ALCANCE",
	"COTIZACION_SITIOS_HM.OPCION_8H_O_4H",
	"COTIZACION_SITIOS_HM.MATRIZ_PRINCIPAL",
	"COTIZACION_SITIOS_HM.TEMPORAL_O_FIJO",
	"COTIZACION_SITIOS_HM.ID_DOMICILIO_SITIO",
	"COTIZACION_SITIOS_HM.SELECCIONADO",
...
$cotizacion_sitios = $database->select("COTIZACION_SITIOS_HM", ["[>]".$tabla_entidad => ["ID_DOMICILIO_SITIO" => "ID"]], $campos, ["ID_COTIZACION"=>$cotizacio_tramite["ID"]]);
valida_error_medoo_and_die();
