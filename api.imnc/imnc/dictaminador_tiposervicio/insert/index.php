...
function valida_parametro_and_die($parametro, $mensaje_error){ 
	...
	if($database->count("DICTAMINADOR_TIPO_SERVICIO", ["AND"=>[	"ID_USUARIO" => $ID_USUARIO,"ID_TIPO_SERVICIO" => $ID_TIPO_SERVICIO ]]) == 0){
		$id = $database->insert("DICTAMINADOR_TIPO_SERVICIO", [			
		...
		$respuesta['resultado']="error";
		$respuesta['mensaje']="Este tipo de servicio ya esta cargado para este dictaminador ";
