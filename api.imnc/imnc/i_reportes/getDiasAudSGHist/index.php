...
$consulta = "SELECT 
				...
				`ISAF`.`FECHA`
						...
						INNER JOIN `I_SG_AUDITORIA_FECHAS` `ISAF` ON `ISA`.`ID_SERVICIO_CLIENTE_ETAPA` = `ISAF`.`ID_SERVICIO_CLIENTE_ETAPA` AND `ISA`.`TIPO_AUDITORIA` = `ISAF`.`TIPO_AUDITORIA` AND `ISA`.`CICLO` = `ISAF`.`CICLO`
						WHERE 
							`ISA`.`STATUS_AUDITORIA`='2' AND `ISAF`.`FECHA` LIKE '".$ano_1."%' ";
...
$consulta = "SELECT 
				...
				`ISAF`.`FECHA`
						...
						INNER JOIN `I_SG_AUDITORIA_FECHAS` `ISAF` ON `ISA`.`ID_SERVICIO_CLIENTE_ETAPA` = `ISAF`.`ID_SERVICIO_CLIENTE_ETAPA` AND `ISA`.`TIPO_AUDITORIA` = `ISAF`.`TIPO_AUDITORIA` AND `ISA`.`CICLO` = `ISAF`.`CICLO`
						WHERE 
							`ISA`.`STATUS_AUDITORIA`='2' AND `ISAF`.`FECHA` LIKE '".$ano_2."%'  ";
...
$consulta = "SELECT 
				...
				`ISAF`.`FECHA`
						...
						INNER JOIN `I_SG_AUDITORIA_FECHAS` `ISAF` ON `ISA`.`ID_SERVICIO_CLIENTE_ETAPA` = `ISAF`.`ID_SERVICIO_CLIENTE_ETAPA` AND `ISA`.`TIPO_AUDITORIA` = `ISAF`.`TIPO_AUDITORIA` AND `ISA`.`CICLO` = `ISAF`.`CICLO`
						WHERE 
							`ISA`.`STATUS_AUDITORIA`='2' AND `ISAF`.`FECHA` LIKE '".$ano_3."%' ";
...
$consulta = "SELECT 
				...
				`ISAF`.`FECHA`
						...
						INNER JOIN `I_SG_AUDITORIA_FECHAS` `ISAF` ON `ISA`.`ID_SERVICIO_CLIENTE_ETAPA` = `ISAF`.`ID_SERVICIO_CLIENTE_ETAPA` AND `ISA`.`TIPO_AUDITORIA` = `ISAF`.`TIPO_AUDITORIA` AND `ISA`.`CICLO` = `ISAF`.`CICLO`
						WHERE 
							`ISA`.`STATUS_AUDITORIA`='2' AND `ISAF`.`FECHA` LIKE '".$ano_4."%'  ";
