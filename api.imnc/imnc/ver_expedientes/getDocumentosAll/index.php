...
for($i=0;$i<count($DOCUMENTOS);$i++){
	$ESTADO_DOCUMENTO = $database->select("BASE_DOCUMENTOS",["ESTADO_DOCUMENTO","EXTENSION_DOCUMENTO"],["AND"=>["ID_CATALOGO_DOCUMENTOS"=>$DOCUMENTOS[$i]["ID"],"ID_SERVICIO"=>$id_servicio_cliente_etapa,"CICLO"=>$nombre_ciclo]]);
