...
$ID = $_REQUEST["id"]; 
$SELECCIONADO = intval($database->get("COTIZACION_TRAMITES_SITIOS", "SELECCIONADO", ["ID"=>$ID]));
$SELECCIONADO = abs($SELECCIONADO-1);

$database->update("COTIZACION_TRAMITES_SITIOS", ["SELECCIONADO"=>$SELECCIONADO], ["ID"=>$ID]); 
