...
$cotizacio_tramite = $database->get("COTIZACIONES_TRAMITES_DH", "*", ["ID"=>$id]); 
valida_error_medoo_and_die(); 
...
$cantidad_de_sitios = $database->count("COTIZACION_SITIOS_DH", ["ID_COTIZACION"=>$cotizacio_tramite["ID"]]);
valida_error_medoo_and_die(); 



$campos = [
	"COTIZACION_SITIOS_DH.ID",
	"COTIZACION_SITIOS_DH.ID_COTIZACION",
	"COTIZACION_SITIOS_DH.NUM_COCINAS",
	"COTIZACION_SITIOS_DH.UNI_REF_CONG",
	"COTIZACION_SITIOS_DH.CENTRO_CONSUMO",
	"COTIZACION_SITIOS_DH.CANTIDAD_DIAS",
	"COTIZACION_SITIOS_DH.MATRIZ_PRINCIPAL",
	"COTIZACION_SITIOS_DH.TEMPORAL_O_FIJO",
	"COTIZACION_SITIOS_DH.ID_DOMICILIO_SITIO",
	"COTIZACION_SITIOS_DH.SELECCIONADO",
