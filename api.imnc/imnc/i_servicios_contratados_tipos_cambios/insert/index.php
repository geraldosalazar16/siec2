...
*/
//$NOMBRE =""; //$objeto->UBICACION_DOCUMENTOS; 
//valida_parametro_and_die($ubicacion_documentos, "Falta ubicacion_documentos");

$NOMBRE = $objeto->NOMBRE; 
valida_parametro_and_die($NOMBRE, "Falta el NOMBRE del tipo de cambio");

$DESCRIPCION = $objeto->DESCRIPCION; 
valida_parametro_and_die($DESCRIPCION, "Falta la descripcion del tipo de cambio");
