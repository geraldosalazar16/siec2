...
$solicitudes = $database->select("FACTURACION_SOLICITUDES", [
	...
	"[>]I_SG_AUDITORIAS"=>["ID_SERVICIO_CLIENTE_ETAPA"=>"ID_SERVICIO_CLIENTE_ETAPA","ID_TIPO_AUDITORIA"=>"TIPO_AUDITORIA","CICLO"=>"CICLO"],
	"[>]I_SG_AUDITORIAS_TIPOS"=>["I_SG_AUDITORIAS.TIPO_AUDITORIA"=>"ID"],
	...
	"I_SG_AUDITORIAS_TIPOS.TIPO(AUDITORIA)",
	"TIPOS_SERVICIO.NOMBRE(TIPO_SERVICIO)"
]);
