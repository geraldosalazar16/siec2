...
$ID_CLIENTE_DOMICILIO = $objeto->DOMICILIO; 
...
/*===========================================================*/
if($ID_ACTIVIDAD==" "){
	$ultimo_id =	$database->max("SG_ACTIVIDAD","ID");
	$ID_ACTIVIDAD = 	$ultimo_id	+	1;
}
/*===========================================================*/
/*
$validacion = $database->count("I_SG_SITIOS", ["AND" => ["ID_SERVICIO_CLIENTE_ETAPA" => $ID, "ID_CLIENTE_DOMICILIO" => $ID_CLIENTE_DOMICILIO]]); 

$obj_validar =  $database->get("I_SG_SITIOS", ["ID_SERVICIO_CLIENTE_ETAPA", "ID_CLIENTE_DOMICILIO"], ["ID_SERVICIO_CLIENTE_ETAPA" => $ID]);
...
*/
$id = $database->update("I_SG_SITIOS", [ 
