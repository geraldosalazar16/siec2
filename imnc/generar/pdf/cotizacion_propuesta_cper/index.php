...
$area = "de Certificación de Personas";//$cotizacion[0]['SERVICIO']["NOMBRE"];
...
foreach ($tramites as $key => $tramite_item) {
		$ruta = $global_apiserver.'/cotizaciones_tramites_cper/getSitios/?id='.$tramite_item->ID.'&cotizacion='.$id_cotizacion;
...
<table cellpadding="2" cellspacing="0"  border="1" bordercolor=#0000FF style="text-align:center;" width="450">
	...
	<tr>
		<td style="font-size: medium; text-align:right" width="100">Cantidad de personas:</td>
		<td style="font-size: medium;  text-align:left" width="350"> $cant_personas</td>
...
$html .= '<br><b>Viáticos:</b> En caso de la evaluación sea fuera de la zona metropolitana de la Cd. De México, los costos correspondientes a transportes aéreos y/o autobús, hospedaje, alimentos y los costos por traslados en taxi en la Cd. de México de los auditores del IMNC, los cubrirá la persona solicitante.';
$html .= '<br>Nota: Cuando aplique los itinerarios de vuelos deberán ser aprobados por el IMNC antes de ser comprados. Es necesario que como máximo 5 días antes de la fecha de ejecución del servicio se envíen al IMNC los vuelos y hospedajes.';
$html .= '<br><b>NOTA 2:</b> Se le requiere a la persona certificada  informe al organismo de certificación, sin demora, sobre cuestiones que puedan afectar la capacidad    para continuar cumpliendo los requisitos de certificación.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 10);
$html ='<b> IMPORTANTE<b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' En caso de aceptar la presente propuesta económica,  favor de efectuar un pago mínimo del 50% sobre el monto total de cada servicio y el 100% de los viáticos o Gastos adicionales si aplica en el momento de la programación de cada evaluación, como mínimo 5 días antes de la ejecución, para tal efecto se deberá enviar por correo electrónico el comprobante de pago (ficha de depósito o transferencia bancaria) a <a>hcruz@imnc.org.mx</a>, en caso contrario el servicio se postergará hasta contar con dicho comprobante; el 50% restante se cubrirá a la conclusión del servicio. Para la emisión del certificado se deberá contar con el comprobante de pago.';
...
$html =' <br><b>Servicios de mantenimiento</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' <br>Los servicios de mantenimiento (vigilancia) se realizarán preferentemente de forma anual a los 12 y 24 meses después de la evaluación inicial ';
$html .=' <br><b>Importante:</b> Los costos de las vigilancias Anuales no incluyen viáticos. ';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>Tiempo de respuesta </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' <br>Las fechas para realizar la evaluación se programarán de común acuerdo. Para la ejecución de la evaluación es requisito indispensable que se envié la propuesta económica aceptada. De ser positivo el proceso de certificación la entrega del certificado y/o dictamen se hará de 15 a 20 días hábiles a la toma de decisión. ';
...
$html .=' <br><br><b>Nota1: </b> A excepción de la cotización aceptada, el envío de los documentos  anteriores y el pago anticipado no aplica para sector público.';
