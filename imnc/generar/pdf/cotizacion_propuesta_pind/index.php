...
$area = " de Certificación de Producto Industrial";//$cotizacion[0]['SERVICIO']["NOMBRE"];
...
foreach ($tramites as $key => $tramite_item) {
		$ruta = $global_apiserver.'/cotizaciones_tramites_pind/getSitios/?id='.$tramite_item->ID.'&cotizacion='.$id_cotizacion;
...
<table cellpadding="3" cellspacing="0" border="0">
	...
	<tr>
		...
		<td style="font-size: small; text-align:center;" width="400">
			...
			Lada sin costo: 01 800 201 0145 Teléfono: 5546 4546 con diez líneas, Fax: 5705 3686<br>
...
for($i=0;$i<count($datos);$i++){
	if($i==3 || $i == 7 || $i==11){
		...
		$costo_total_visita_inspeccion = $obj_cotizacion_tramite[$i]->COSTO_TOTAL_VISITA_INSPECCION;
		$costo_total_ensayos = $obj_cotizacion_tramite[$i]->COSTO_TOTAL_ENSAYOS;
		...
		<table cellpadding="2" cellspacing="0"  border="1" bordercolor=#0000FF style="text-align:center;" width="450">
			...
			<tr>
				...
				<th style="font-size: medium; background-color: #D8E4F0;" width="100"><strong>Cantidad</strong></th>
...
EOT;
			...
			if(count($datos1[$i])>0){
				...
				$cantidad_cert = $datos1[$i][$j]->CANTIDAD;
...
$html =' <br><br><b>Vigencia de la cotización</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' La presente cotización tiene una vigencia de 30 días naturales a partir de la fecha de emisión.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>Viáticos </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' Los costos correspondientes ya están incluidos en la presente cotización.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>Tiempo de respuesta</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' Las fechas para realizar la evaluación se programará de común acuerdo. Si por alguna razón o circunstancias ajenas al IMNC usted desea
cambiar las fechas acordadas y confirmadas para la realización de cualquiera de los eventos deberá informar al Instituto con una
anticipación límite de 10 días naturales antes de la fecha de ejecución del servicio. La entrega del certificado (cuando aplique) se hará de 10
a 15 días hábiles posteriores al resultado del Comité de Dictaminación.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>Condiciones generales</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' El pago del servicio cotizado, deberá ser de la siguiente forma:';
$html .= '<br>&nbsp;&nbsp;&nbsp; <b>1. Cubrir el total de la cotización en una sola exhibición antes de realizar la visita de inspección.</b> <br> Para los pagos con depósito bancario, transferencia o cheque empresarial a nombre del Instituto Mexicano de Normalización y Certificación, A.C. deberá colocar el número de cotización a las siguientes cuentas bancarias:';
$html .= '<br>&nbsp;&nbsp;&nbsp;&nbsp; a) <b>BANAMEX</b> cuenta No. 096530-8 Suc. San Rafael No. 224. Para transferencia Inter. Bancaria: CLAVE BANCARIA ESTÁNDAR (CLABE)
002180022409653080';
$html .= '<br>&nbsp;&nbsp;&nbsp;&nbsp; b) <b>SCOTIA BANK</b> Suc. 28 Sullivan plaza 1 México, D.F. Cuenta 001 006 90669 Instituto Mexicano de Normalización y Certificación, A.C.
CUENTA CLABE: 044 18000 100690669 8';
$html .= '<br><br><br>Si la presente cotización es aceptada,<b> favor de firmar en el espacio correspondiente y reenviar al IMNC esta cotización.</b>';
$html .= '<br>Anexar copias simples de los siguientes documentos: acta constitutiva, identificación del representante legal, comprobante de domicilio y RFC
(en caso de certificación inicial).';
$html .= '<br><b>NOTA:</b> Favor de indicar el nombre del responsable de los pagos, cargo y teléfono.';
$html .= '<br><br><br>';
$pdf1->writeHTML($html, true, false, true, false, '');
...
<table cellpadding="15" cellspacing="0" border="0" style="text-align:center;">
	...
	<tr>
		<td style="font-size: medium;" width="219">
				...
				____________________________________<br>IMNC A.C.<br>Ing. Juan Antonio Ramos Ramirez<br>Coordinador de Certificación de Producto
