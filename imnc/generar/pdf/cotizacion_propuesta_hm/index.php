...
$area = "de la Certificación del Emblema Hecho en México";//$cotizacion[0]['SERVICIO']["NOMBRE"];
...
foreach ($tramites as $key => $tramite_item) {
		$ruta = $global_apiserver.'/cotizaciones_tramites_hm/getSitios/?id='.$tramite_item->ID.'&cotizacion='.$id_cotizacion;
...
<table cellpadding="3" cellspacing="0" border="0">
	...
	<tr>
		...
		<td style="font-size: small; text-align:left;" width="115"> 
			Clave: FPPr56 <br>
			Fecha de aplicación: 2019-01-15 <br>
			Versión: 02 <br>
...
EOT;
$pdf1->writeHTML($html, true, false, true, false, '');
// AQUI VA LA TABLA PARA LO QUE SE CAPTURE COMO ALCANCE
$alcance = $obj_cotizacion_tramite[0]->COTIZACION_SITIOS[0]->ALCANCE;
$html = <<<EOT
<br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<table cellpadding="2" cellspacing="0"  border="1" bordercolor=#0000FF style="text-align:center;" width="450">
	<tr style="background-color: #1F487B;">
		<th style="font-size: large; color:white;" colspan="1"><strong>ALCANCE</strong></th>
	</tr>
	<tr>
		<td style="font-size: medium; text-align:left" >$alcance</td>
...
$html =' <b>CONDICIONES GENERALES</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>1. Impuestos.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' Lo referente al I.V.A. o impuestos ya están incluidos en la presente Propuesta económica.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>2. Gastos de Servicio.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' La presente Propuesta económica incluye lo relacionado a gastos de servicio (Transportación, Alimentación y Hospedaje) y tendrán que ser cubiertos por la empresa, siempre y cuando la localización a realizar los servicios este fuera de la Ciudad de México.';
$html .= '<br> En caso de que la empresa requiera hacerse cargo de los gastos de servicio para economizar recursos, tendrá que notificar al IMNC con al menos 15 días hábiles de antelación al servicio programado.';
$html .= '<br> Cuando aplique los itinerarios de vuelos deberán ser aprobados por el IMNC antes de ser comprados. Es necesario que como mínimo 5 días hábiles antes de la fecha de ejecución del servicio se envíen al IMNC los vuelos, hospedajes y transportación local.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>3. Vigencia de la Propuesta económica.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' La presente Propuesta económica tiene una vigencia de 120 (ciento veinte) días naturales y contaran a partir de la fecha de emisión.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>4. Especificaciones Técnicas. </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' El número de horas de evaluación de esta Propuesta económica, tiene como base los criterios establecidos por el IMNC. La presente propuesta económica ha sido emitida con base en la información que el cliente ha hecho de conocimiento al IMNC, mediante la “Solicitud y cuestionario de Certificación del Emblema Hecho en México” correspondiente.';
$html .= '<br> La evaluación consta de 4 horas en instalaciones del cliente, por planta. La empresa deberá de cumplir los requisitos establecidos en las Condiciones de certificación.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>4.1 Certificación Inicial.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' Es la primera evaluación realizada por el IMNC, como organismo de certificación acreditado por la entidad mexicana de acreditación (ema) y se realizará en las instalaciones del cliente. ';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>4.2 Evaluación de Vigilancia. </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' El servicio de evaluación de Vigilancia se especifica en la presente Propuesta económica sobre la base que debe realizarse una vigilancia al año de vigencia del certificado.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>4.2 Evaluación de Vigilancia. </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
...
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>4.3 Renovación de la certificación.  </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' Para el servicio de Renovación de la certificación se debe solicitar una nueva Propuesta económica sobre la base que debe realizarse antes de la fecha de vencimiento del certificado.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>4.4 Certificado. </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' La <b>vigencia del certificado</b> emitido por el IMNC será de 2 años y será válido siempre y cuando este acompañado por el dictamen de cada evaluación que realice el IMNC (Certificación inicial y Vigilancia de la certificación).';
$html .= '<br> La entrega del documento de certificación, se hará a los 8 días hábiles posteriores a la dictaminación.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>4.5 Modificaciones al certificado.  </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' Si durante la vigencia del certificado, surge la necesidad de hacer modificaciones al Certificado (por ejemplo: razón social de la empresa, dirección, ampliación o reducción de productos), tendrá un costo de <b>$3,000.00 más I.V.A.</b> por cambio realizado.';
$pdf1->writeHTML($html, true, false, true, false, '');
//
// SE PASA A LA SIGUIENTE PAGINA
//
$pdf1->AddPage();
$pdf1->SetTextColor(0,0,0);
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><b>4.6 Cambios en la organización del cliente.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' El cliente se obliga a informar al IMNC dentro de los primeros 15 días hábiles posteriores a estos, cambios que puedan afectar la certificación del emblema Hecho en México y para continuar cumpliendo los requisitos del documento de referencia para la certificación, Por ejemplo: cambios en la condición legal, comercial o de propiedad; los componentes del producto final (por ejemplo: origen de las materias primas), cambio de domicilio y lugar de contacto; el alcance de las operaciones y productos cubiertos por la certificación del emblema Hecho en México. En tales casos el IMNC se reserva el derecho de determinar si es necesario conducir una evaluación especial, y en su caso emitirá una nueva Propuesta económica del servicio para el visto bueno del cliente.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>5. Cancelación.  </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' La cancelación de esta Propuesta económica, podrá ser en cualquier momento por cualquiera de las partes, cuando se presenten los siguientes supuestos:';
$html .= '<br>&nbsp;&nbsp;&nbsp; a)	A solicitud del cliente, mediante un comunicado por escrito y con una antelación de 3 meses en relación a la fecha de inicio de cualquiera de los servicios programados.';
$html .= '<br>&nbsp;&nbsp;&nbsp; b)	Por no pagar las contraprestaciones correspondientes a los anticipos y/o a los servicios ejecutados por el IMNC.';
$html .= '<br>&nbsp;&nbsp;&nbsp; c)	Por incumplimiento de las obligaciones definidas a cargo de cada una de las partes en el presente documento ';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>6. Programación y Logística.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' Para la programación y ejecución de la inspección, es requisito indispensable que el cliente ingrese al IMNC la Propuesta Económica firmada por el Representante legal.<br>
Las fechas para realizar la inspección, serán programadas de común acuerdo con al menos 15 días naturales de antelación. En caso de que la organización solicite la reprogramación y/o cancelación de la inspección ya confirmada, dentro de los 5 días naturales de antelación a la fecha de ejecución del servicio, el IMNC facturará el 25% del importe del servicio correspondiente por gastos administrativos.<br>
En reprogramaciones por parte del cliente dentro de los 5 días naturales de antelación al servicio donde  se requiera realizar modificaciones al equipo evaluador para cubrir el ejercicio de inspección, el cliente absorberá los gastos correspondientes. 
';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>7. Facturación.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' El IMNC con una semana de antelación al servicio, emitirá un pedido (pre-factura) al cliente. El IMNC enviará la factura al cliente, máximo el mismo día de la ejecución de la inspección, o antes en caso de haber confirmado el pedido o por solicitud expresa del cliente.<br>
Toda re facturación tendrá un costo administrativo de $150.00 pesos adicional al monto de la factura, toda factura con adeudo mayor a 30 días tendrá un cargo del 5% de interés mensual tomando como referencia el monto total del adeudo de la factura, hasta la fecha de su liquidación, si se rebasan los 45 días su adeudo será turnado al área legal.
';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>8. Condiciones de pago. </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' IMPORTANTE: Los pagos de los servicios serán con cheque empresarial, depósito bancario o transferencia bancaria a nombre del Instituto Mexicano de Normalización y Certificación, A.C. a cualquiera de las cuentas siguientes: ';
$html .= '<br>&nbsp;&nbsp;&nbsp; *	<b>BANAMEX</b> Sucursal 224 Cto. No. 096530-8 plaza Metropolitana, Apertura de la cuenta Deleg. Cuauhtémoc, D.F. ';
$html .= '<br>&nbsp;&nbsp;&nbsp; *	<b>BBVA BANCOMER</b> Sucursal 3470  Parque Vía, No. Cta. 0449650067 Clabe 012180004496500675';
$html .= '<br>&nbsp;&nbsp;&nbsp; *	<b>SCOTIABANK</b> No. 00100690669 Suc. 28 Sullivan Plaza 1 México, D.F CLABE 044180001006906698. En caso de realizar directamente el pago en ventanilla, favor de comunicarse al IMNC para proporcionarle el No. de Referencia.';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>9. Aceptación de la Propuesta económica. </b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' Al firmar esta Propuesta económica, está generando la <b>aceptación de la Contratación de los servicios</b> y su organización manifiesta que ha leído, comprendido y acepta las Condiciones de Certificación del Emblema “Hecho en México” vigentes.<br>
En caso de aceptar la presente Propuesta económica, favor de efectuar el pago del 100% sobre el monto total de cada servicio y el 100% de los viáticos o Gastos adicionales en el momento de la programación de cada inspección, como mínimo 5 días hábiles antes de la ejecución de la inspección, para tal efecto se deberá enviar por correo electrónico el comprobante de pago (ficha de depósito o transferencia bancaria) a aavalos@imnc.org.mx y facturacion@imnc.org.mx, en caso contrario se procederá conforme a las Condiciones de Certificación vigentes. Para la entrega del Dictamen de certificación y el Certificado se deberá contar con el comprobante de pago.
';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>10. Usos del Emblema.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' El cliente se deberá apegar al Reglamento para el uso y aplicación del emblema Hecho en México vigente, el cual será proporcionado por el IMNC.<br>
Así mismo, para el uso del emblema Hecho en México, en ningún caso deberán alterarse o modificarse las proporciones o la composición y distribución de los elementos que conforman la identidad gráfica o de cualquiera de sus elementos.';
$pdf1->writeHTML($html, true, false, true, false, '');
//
// SE PASA A LA SIGUIENTE PAGINA
//
...
$pdf1->SetTextColor(0,0,0);
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><b>11. Precios.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' Esta Propuesta económica está acorde a la Política de precios vigente del IMNC.<br>
Esta Propuesta económica se expresa en moneda nacional MXN  (Pesos mexicanos).';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 11);
$html =' <br><br><b>12. Confidencialidad.</b>';
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html = '<br> Toda la información obtenida durante la ejecución de las actividades de la evaluación de la conformidad, será manejada estrictamente de manera reservada y confidencial por parte del IMNC y no podrá ser revelada a un tercero o persona particular, sin el previo consentimiento por escrito del cliente.<br>
 Cuando el IMMC sea requerido por la Ley a divulgar información confidencial, el cliente deberá ser notificado antes de proporcionar dicha información, salvo que esté prohibido por la Ley.<br>
...
';
$html .= '<br><br><br>En espera de vernos favorecidos con su preferencia, quedamos a sus órdenes.';
$html .= '<br><br><br>';
$pdf1->writeHTML($html, true, false, true, false, '');
...
<table cellpadding="15" cellspacing="0" border="0" style="text-align:center;">
	...
	<tr>
		<td style="font-size: medium;" width="219">
				...
				____________________________________<br>IMNC A.C.<br>Fernando Solis Mata<br>Jefe de ventas de Evaluación de la Conformidad
...
$pdf1->writeHTML($html, true, false, true, false, '');
$pdf1->SetFont('Calibri', '', 9);
$html =' <br><br> Debemos y pagaremos incondicionalmente por este Pagaré a la orden del Instituto Mexicano de Normalización y Certificación, A.C. en Ciudad de México en la fecha comprometida y por el monto que ha sido pactado en esta Propuesta Económica / pedido / celebrado entre ambas partes. Valor recibido a entera satisfacción del Instituto Mexicano de Normalización y Certificación, A.C.<br>
