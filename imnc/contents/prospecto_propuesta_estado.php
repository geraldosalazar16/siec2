<span ng-controller="prospecto_propuesta_estado_controller">
          ...
          <table class="table table-striped responsive-utilities jambo_table bulk_action">
            <thead>
              <tr class="headings">
                ...
                <th class="column-title">Estado / Propuesta</th>
				<th class="column-title">&nbsp;</th>
              </tr>
            </thead>

            <tbody>
				<tr ng-repeat="x in tipodocumento" class="ng-scope even pointer">
					<td>{{$index + 1}}</td>
					<td>{{x.ESTADO}}</td>					
					<td>
      ...
      <div class="modal-body">
          <form name="form2" id="form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
            ...
            <div class="form-group">
              <label class="control-label col-md-4 col-sm-4 col-xs-12">Propuesta Estado<span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="estado" required="required" class="form-control col-md-7 col-xs-12" ng-model="estado" data-parsley-id="2324" ><ul class="parsley-errors-list" id="parsley-id-2324"></ul>
