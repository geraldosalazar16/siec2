<div class="right_col" role="main"  ng-controller="ver_cotizacion_DH_controller as $ctrl" ng-init='despliega_cotizacion()' ng-cloak>
  <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-4">
              <ul class="list-unstyled user_data">
                  ...
                  <li>
                    ...
                    ng-if='modulo_permisos["registrar"] == 1 && !bl_cotizado' ng-disabled="obj_cotizacion_tramite.COUNT_SITIOS.SITIOS_A_VISITAR>0">
          ...
          <table class="table table-striped responsive-utilities jambo_table bulk_action" style="margin: 25px 0px 45px;">
            <thead>
              <tr class="headings">
				...
				<th class="column-title"> Cantidad de D&iacuteas </th>
            ...
            <tbody>
              <tr class="even pointer" ng-repeat="sitios_cotizacion in arr_sitios_cotizacion">
				...
				<td>
					Unidades de refrigeraci&oacuten y congelaci&oacuten : {{sitios_cotizacion.UNI_REF_CONG }}<br>
					Centros de consumo : {{sitios_cotizacion.CENTRO_CONSUMO }}<br>
					N&uacutemero de cocinas : {{sitios_cotizacion.NUM_COCINAS }}<br>
                </td>
				<td>{{sitios_cotizacion.CANTIDAD_DIAS}}</td>
                <td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="demo-form2" style="margin-top: -20px;">
			  ...
			  <div class="form-group form-vertical">
                <label class="control-label col-md-12">Unidades de refrigeraci&oacuten y congelaci&oacuten <span class="required">*</span></label>
                <div class="col-md-12">
                  <input type="numeric" ng-model="obj_sitio.UNI_REF_CONG" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
			 <div class="form-group form-vertical">
                <label class="control-label col-md-12">Centros de consumo <span class="required">*</span></label>
                <div class="col-md-12">
                  <input type="numeric" ng-model="obj_sitio.CENTRO_CONSUMO" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
			  <div class="form-group form-vertical">
                <label class="control-label col-md-12">N&uacutemero de cocinas <span class="required">*</span></label>
                <div class="col-md-12">
                  <input type="numeric" ng-model="obj_sitio.NUM_COCINAS" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
			    <div class="form-group form-vertical">
              ...
              <div class="form-group form-vertical">
			   ...
			   <div class="form-group form-vertical">
                <label class="control-label col-md-12">Cantidad de D&iacuteas <span class="required">*</span></label>
                <div class="col-md-12">
                  <input type="numeric" ng-model="obj_sitio.CANTIDAD_DIAS" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
            </form>
        </div>
