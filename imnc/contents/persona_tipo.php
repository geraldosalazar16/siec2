<div class="right_col" role="main">
  <div class="row">
    <div class="col-md-6 col-sm-6 col-xs-6">
      <div class="x_panel">
        <div class="x_title">
        <p><h2><?php echo $str_tipo_persona; ?></h2></p>
        <?php
          if ($modulo_permisos["CLIENTES"]["catalogos"] == 1) {
              ...
              echo '    <i class="fa fa-plus"> </i> Agregar ' . $str_tipo_persona;
              echo '  </button>';
              echo '</p>';
          } 
        ?>
        ...
        <div class="x_content">
          ...
          <table class="table table-striped responsive-utilities jambo_table bulk_action">
            <thead>
              <tr class="headings">
                <th class="column-title">Clave de tipo de persona</th>
                <th class="column-title">Tipo de persona</th>
...
<div class="modal fade" id="modalInsertarActualizar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      ...
      <div class="modal-body">
          <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
            <div class="form-group">
              <label class="control-label col-md-4 col-sm-4 col-xs-12">Clave de tipo de persona<span class="required">*</span>
              </label>
            ...
            <div class="form-group">
              <label class="control-label col-md-4 col-sm-4 col-xs-12">Tipo de persona <span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
  ...
  <?php
    echo "var global_str_tipo_persona = '" . $str_tipo_persona . "';";
  ?>
  </script>