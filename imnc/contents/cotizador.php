              ...
              <tr class="even pointer" ng-repeat="cotizacion in arr_cotizaciones">
                ...
                <td>
				  ...
				  <div ng-show = "cotizacion.ID_TIPO_SERVICIO == 18">
					...
					<div ng-show = "cotizacion.ID_TIPO_SERVICIO == 14">
						<a type="button" class="btn btn-primary btn-xs btn-success btnVerCotizacion" href="./?pagina=ver_cotizacion_DH&id_cotizacion={{cotizacion.ID}}" style="float: right;">
							<i class="fa fa-bullseye"></i> Ver cotización
						</a>	
					</div>
					<div ng-show = "cotizacion.ID_TIPO_SERVICIO == 15">
						<a type="button" class="btn btn-primary btn-xs btn-success btnVerCotizacion" href="./?pagina=ver_cotizacion_HM&id_cotizacion={{cotizacion.ID}}" style="float: right;">
							<i class="fa fa-bullseye"></i> Ver cotización
						</a>	
					</div>
					<div ng-show = "cotizacion.ID_TIPO_SERVICIO == 13">
						<a type="button" class="btn btn-primary btn-xs btn-success btnVerCotizacion" href="./?pagina=ver_cotizacion_PInd&id_cotizacion={{cotizacion.ID}}" style="float: right;">
							<i class="fa fa-bullseye"></i> Ver cotización
						</a>	
					</div>
                </td>
