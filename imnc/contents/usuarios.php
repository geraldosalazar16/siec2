<div class="right_col" role="main" ng-controller="usuarios_controller as $ctrl" ng-init='despliega_usuarios()' ng-cloak>
        ...
        <div class="modal-body">
            <form id="demo-form2" style="margin-top: -20px;">
              ...
              <div class="form-group form-vertical">
                ...
                <div class="col-md-12">
                  <select ng-model="usuario_insertar_editar.ID_PERFIL"  class="form-control" id="cmbPerfiles" ng-options="perfil as perfil.PERFIL for perfil in arr_perfiles track by perfil.ID">
