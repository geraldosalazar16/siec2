<div class="right_col" role="main"  ng-controller="ver_cotizacion_PInd_controller as $ctrl" ng-init='despliega_cotizacion()' ng-cloak>
  <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-4">
              <ul class="list-unstyled user_data">
                  ...
                  <li>
                    ...
                    ng-if='modulo_permisos["registrar"] == 1 && !bl_cotizado' ng-disabled="">
          ...
          <table class="table table-striped responsive-utilities jambo_table bulk_action" style="margin: 25px 0px 45px;">
            ...
            <tbody>
              <tr class="even pointer" ng-repeat="sitios_cotizacion in arr_sitios_cotizacion">
				...
				<td>
					Alcance : <i>{{sitios_cotizacion.ALCANCE }}</i><br>
					Productos : <i>{{sitios_cotizacion.PRODUCTOS_LISTA }}</i> <br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="demo-form2" style="margin-top: -20px;">
			  ...
			  <div class="form-group form-vertical">
                <label class="control-label col-md-12">Alcance <span class="required">*</span></label>
                <div class="col-md-12">
					<textarea  type='text' class="form-control col-md-7 col-xs-12" ng-model="obj_sitio.ALCANCE" cols='50' rows='4' required='required'> </textarea> 
                </div>
              </div>
			<div class="form-group form-vertical" >
                <label class="control-label col-md-12">Productos</label>
                <div class="col-md-12">
                      <multiple-autocomplete ng-model="obj_sitio.PRODUCTOS_INDUSTRIALES"
                      object-property="NOMBRE"
                      suggestions-arr="PRODUCTOS_INDUSTRIALES_ARR">
				...
				<div class='form-group' ng-repeat="x in arr_tramites_cotizacion" ng-init="tram_index = $index" >
					...
					<div class='form-group' ng-repeat="y in tarifa_adicional_tramite_cotizacion_by_tramite[tram_index]" >
						...
						<div class='form-group  col-md-3 col-xs-3 col-sm-3'>
							<input type="text" class="form-control"  ng-model="formDataGenCotizacion.descripcion[tram_index][$index].CANTIDAD" required ng-class="{ error: exampleFormGenCotizacion.descipcion.$error.required && !exampleForm.$pristine}"  disabled > 
						</div>
					<!--	<div class='form-group  col-md-3 col-xs-3 col-sm-3'>
