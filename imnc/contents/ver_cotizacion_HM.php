<div class="right_col" role="main"  ng-controller="ver_cotizacion_HM_controller as $ctrl" ng-init='despliega_cotizacion()' ng-cloak>
  <div class="row">
            ...
            <tbody>
              <tr class="even pointer" ng-repeat="sitios_cotizacion in arr_sitios_cotizacion">
				...
				<td>
					...
					Tiempo de Visita : <i ng-if="sitios_cotizacion.OPCION_8H_O_4H == 0">4</i><i ng-if="sitios_cotizacion.OPCION_8H_O_4H == 1">8</i> <i>horas</i><br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="demo-form2" style="margin-top: -20px;">
			 ...
			 <div class="form-group form-vertical">
                <label class="control-label col-md-12">Tiempo de visita <span class="required">*</span></label>
                <div class="col-md-12">
                  <select  ng-model="obj_sitio.OPCION_8H_O_4H" class="form-control">
                     <option value="" selected disabled>-- selecciona una opción --</option>
                     <option value="0">Visita 4 Horas</option>
                     <option value="1">Visita 8 Horas</option>
                  </select>
                </div>
              </div>
