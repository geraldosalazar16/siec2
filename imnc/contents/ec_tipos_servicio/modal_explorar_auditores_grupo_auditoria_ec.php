...
<div class="modal fade" id="modalExplorarGrupoEC" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="overflow-y: auto;">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="modalTituloExplorarGrupoEC">Seleccionar auditor</h4>
      </div>
      <div class="modal-body" id="body-modalExplorarGrupo">
		<span ng-show="cant_auditoresEC == 0">Actualmente el servicio no cuenta con auditores o los existentes ya est&aacuten cargados en la auditor&iacutea.</span>
          <table class="table">
		...
		<!--		<th>Sectores que cubre</th>	-->
          ...
          <tbody id="tbody-modal-explora-sitios">
            <tr ng-repeat="auditor in AuditoresParaAuditoriaEC">
      ...
      <!--          <td style="font-size: 11px;">
			 ...
			 <tr ng-repeat="auditor in AuditoresParaAuditoriaEC1">
                <td td style="font-size: 12px;">
                    {{auditor.NOMBRE_COMPLETO}}<br>
					{{auditor.REGISTRO}}<br>
					{{auditor.STATUS}}<br>
