<span ng-controller="tarifa_cotizacion_controller">
          ...
          <table class="table table-striped responsive-utilities jambo_table bulk_action">
            <thead>
              <tr class="headings">
                ...
                <th class="column-title">Tarífa por Día Auditor</th>
				<th class="column-title">Tipo Servicio</th>
      ...
      <div class="modal-body">
          <form name="form2" id="form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
            ...
            <div class="form-group">
			 ...
			 <div class="form-group">
              <label class="control-label col-md-4 col-sm-4 col-xs-12">Tipo de servicio	<span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                 <select ng-model="tarifa_cotizacion.ID_TIPO_SERVICIO" required="required" class="form-control col-md-7 col-xs-12" ng-options="servicio.ID as servicio.NOMBRE for servicio in lista_servicio">
