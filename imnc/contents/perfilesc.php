  ...
  <div class="row">
    <div class="col-md-6 col-sm-6 col-xs-6">
      ...
      <div class="x_panel">
        ...
        <p><h2>Módulos</h2></p>
            <p>
          <button type="button" ng-click="openModalModulos()"  class="btn btn-primary btn-xs btn-imnc" style="float: right;">
            <i class="fa fa-plus"> </i> Agregar
          </button>
        </p>
          <div class="clearfix"></div>
        ...
        <div class="x_content">
          ...
          <table class="table table-striped responsive-utilities jambo_table bulk_action">
            <thead>
              <tr class="headings">
                <th class="column-title">#</th>
                <th class="column-title">Modulos</th>
				<th class="column-title">&nbsp;</th>
              </tr>
            </thead>

            <tbody>
				<tr ng-repeat="x in modulos" class="ng-scope even pointer">
					<td>{{$index + 1}}</td>
					<td>{{x.MODULO}}</td>
					<td>
						<button type="button" ng-click="openModalModulos($index)" class="btn btn-primary btn-xs btn-imnc btnEditar" style="float: right;">
...
<div class="modal fade" id="modalInsertarActualizar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
 ...
 <div class="modal fade" id="modalInsertarModulo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      ...
      <div class="modal-body">
          <form name="form2" id="form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="">
            ...
            <div class="form-group">
              <label class="control-label col-md-4 col-sm-4 col-xs-12">Módulo<span class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="modulo" required="required" class="form-control col-md-7 col-xs-12" ng-model="modulo" data-parsley-id="2324" ><ul class="parsley-errors-list" id="parsley-id-2324"></ul>
				        <span class="text-danger">{{modulo_error}}</span>
              </div>
            </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" ng-click="cerrar()">Cerrar</button>
        <button type="button" class="btn btn-primary" ng-click="guardarModulo()"  >Guardar</button>
      </div>
    </div>
  </div>
</div>
