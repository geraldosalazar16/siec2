<span ng-controller="formas_pago_controller">
<div class="right_col" role="main">
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
        <p><h2>Formas de Pago</h2></p>
            <button type="button" id="btnNuevo" class="btn btn-primary btn-xs btn-imnc" style="float: right;" ng-click="onAgregar()"><i class="fa fa-plus"> </i> Agregar Forma de Pago
                </button>
        ...
        <div class="x_content">
          ...
          <table class="table table-striped responsive-utilities jambo_table bulk_action">
            ...
            <tbody>
				<tr ng-repeat="x in formas_pagos" class="ng-scope even pointer">
					<td>{{x.CLAVE}}</td>
					<td>{{x.NOMBRE}}</td>
					<td >
