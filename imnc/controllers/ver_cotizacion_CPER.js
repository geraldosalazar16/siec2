app.controller("ver_cotizacion_CPER_controller", ['$scope','$window', '$http','$document', function($scope,$window,$http,$document){
...
/*			
  ...
  $scope.modal_sitio_editar = function(id){
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizacion_sitios_cper/getById/?id="+id,
    };
  ...
  $scope.modal_tramite_editar = function(id){
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizaciones_tramites_cper/getById/?id="+id,
    };
  ...
  $scope.mostrar_tramite_sitios = function(id){
    ...
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizaciones_tramites_cper/getSitios/?id="+id +"&cotizacion="+global_id_cotizacion,
    };
    $http(http_request).success(function(data) {
      if(data) { 
  ...
  $scope.tramite_guardar = function(){
    ...
    if (accion_tramite == 'insertar') {
       var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizaciones_tramites_cper/insert/",
      ...
      var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizaciones_tramites_cper/update/",
        data: angular.toJson(tramite)
      };
    }
  ...
  $scope.cotizacion_sitio_guardar = function(){
    ...
    if (accion_sitio == 'insertar') {
      var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizacion_sitios_cper/insert/",
      ...
      var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizacion_sitios_cper/update/",
        data: angular.toJson($scope.obj_sitio)
      };
    }
    $http(http_request).success(function(data) {
  ...
  $scope.modal_cotizacion_sitio_eliminar = function(id_cotizacion_sitio){
    var http_request = {
    method: 'GET',
    url: global_apiserver + "/cotizacion_sitios_cper/delete/?id="+id_cotizacion_sitio,
    };
  ...
  $scope.actualiza_sitio_seleccionado = function(id_sitio){
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizacion_sitios_cper/updateSeleccionado/?id="+id_sitio,
    };
