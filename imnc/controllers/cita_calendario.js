...
app.controller('cita_calendario_controller',['$scope','$http', 'Upload',function($scope,$http, Upload){
        ...
        function setCalendar() {
            ...
            var calendar = $('#calendario').fullCalendar({
                ...
                events: function (start, end, timezone, callback) {
                   ...
                   $http.get(  global_apiserver + "/cita_calendario/getAllCitas/?id="+$scope.id_prospecto+"&entidad="+$scope.entidad)
