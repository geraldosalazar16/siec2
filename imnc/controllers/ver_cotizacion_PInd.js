app.controller("ver_cotizacion_PInd_controller", ['$scope','$window', '$http','$document', function($scope,$window,$http,$document){
...
/*			
  ...
  $scope.modal_sitio_insertar = function(){
    ...
    $scope.chkActv = false;
	$scope.obj_sitio.PRODUCTOS_INDUSTRIALES = [];
  ...
  $scope.modal_sitio_editar = function(id){
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizacion_sitios_pind/getById/?id="+id,
    };
  ...
  $scope.modal_tramite_editar = function(id){
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizaciones_tramites_pind/getById/?id="+id,
    };
  ...
  $scope.mostrar_tramite_sitios = function(id){
    ...
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizaciones_tramites_pind/getSitios/?id="+id +"&cotizacion="+global_id_cotizacion,
    };
    $http(http_request).success(function(data) {
      if(data) { 
  ...
  $scope.tramite_guardar = function(){
    ...
    if (accion_tramite == 'insertar') {
       var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizaciones_tramites_pind/insert/",
      ...
      var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizaciones_tramites_pind/update/",
        data: angular.toJson(tramite)
      };
    }
  ...
  $scope.cotizacion_sitio_guardar = function(){
    ...
    if (accion_sitio == 'insertar') {
      var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizacion_sitios_pind/insert/",
      ...
      var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizacion_sitios_pind/update/",
        data: angular.toJson($scope.obj_sitio)
      };
    }
    $http(http_request).success(function(data) {
  ...
  $scope.modal_cotizacion_sitio_eliminar = function(id_cotizacion_sitio){
    var http_request = {
    method: 'GET',
    url: global_apiserver + "/cotizacion_sitios_pind/delete/?id="+id_cotizacion_sitio,
    };
  ...
  $scope.actualiza_sitio_seleccionado = function(id_sitio){
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizacion_sitios_pind/updateSeleccionado/?id="+id_sitio,
    };
  ...
  function clean_checkbox_cambio(){
    ...
    $scope.cmb_list = {};
	 ...
	 function Productos_Industriales(){
	 //$scope.DommicilioProspectos1 = {};
		$http.get(  global_apiserver + "/productos_industriales/getAll/")
		.then(function( response ){
			$scope.PRODUCTOS_INDUSTRIALES_ARR = response.data;
