...
//	======================================================================
$scope.agregar_editar_auditorias = function(accion_auditoria,id_sce,id_tipo_auditoria){
...
// ======================================================================
$scope.btnSitiosAuditoria = function(id_servicio_cliente_etapa,id_tipo_auditoria){
$scope.id_tipo_auditoria = id_tipo_auditoria;
	$http.get(  global_apiserver + "/i_sg_auditoria_sitios/getBySgAuditoria/?id="+id_servicio_cliente_etapa+"&id_tipo_auditoria="+id_tipo_auditoria)
		.then(function( response ){
			...
			$("#collapse-"+id_servicio_cliente_etapa+"-"+id_tipo_auditoria+"-sitios-auditoria").collapse("show");	
		});
}
// ======================================================================
// *****	FUNCION PARA CARGAR LAS FECHAS DE LAS AUDITORIAS		*****
// ======================================================================
$scope.cargarFechasAuditoria = function(id_servicio_cliente_etapa,id_tipo_auditoria){

	$http.get(  global_apiserver + "/i_sg_auditoria_fechas/getBySgAuditoria/?id="+id_servicio_cliente_etapa+"&id_tipo_auditoria="+id_tipo_auditoria)
		.then(function( response ){
			
			$scope.fechasAuditoria[id_tipo_auditoria] = response.data;
			$.each($scope.fechasAuditoria[id_tipo_auditoria], function( i, datos ) {
...
//	=====================================================================
$scope.agregar_editar_fechasAuditoria = function(id_sce,id_tipo_auditoria,accion,id){
