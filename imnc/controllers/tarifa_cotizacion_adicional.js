app.controller('tarifa_cotizacion_adicional_controller', ['$scope', '$http', function($scope,$http) { 
	$scope.modulo_permisos =  global_permisos["COTIZADOR"];
	$scope.tarifa_cotizacion = {};
	$scope.accion = "";
	$scope.catalogo = "tarifa_cotizacion_adicional";
	$scope.titulo = "Tarifas adicionales";
