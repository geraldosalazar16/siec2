app.controller("ver_cotizacion_CIL_controller", ['$scope','$window', '$http','$document', function($scope,$window,$http,$document){
  ...
  $scope.despliega_cotizacion = function () {
    ...
    $http(http_request).success(function(data) {
      if(data) {
		...
		$scope.obj_cotizacion.ACTIVIDAD_ECONOMICA = data[0].DETALLES[0].VALOR;
...
/*			
  ...
  $scope.modal_sitio_editar = function(id){
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizacion_sitios_cil/getById/?id="+id,
    };
  ...
  $scope.modal_tramite_editar = function(id){
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizaciones_tramites_cil/getById/?id="+id,
    };
  ...
  $scope.mostrar_tramite_sitios = function(id){
    ...
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizaciones_tramites_cil/getSitios/?id="+id +"&cotizacion="+global_id_cotizacion,
    };
    $http(http_request).success(function(data) {
      if(data) { 
  ...
  //    REDUCCION : $scope.tramite_insertar_editar.REDUCCION,
    ...
    if (accion_tramite == 'insertar') {
       var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizaciones_tramites_cil/insert/",
      ...
      var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizaciones_tramites_cil/update/",
        data: angular.toJson(tramite)
      };
    }
  ...
  $scope.cotizacion_sitio_guardar = function(){
    ...
    if (accion_sitio == 'insertar') {
      var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizacion_sitios_cil/insert/",
      ...
      var http_request = {
        method: 'POST',
        url: global_apiserver + "/cotizacion_sitios_cil/update/",
        data: angular.toJson($scope.obj_sitio)
      };
    }
    $http(http_request).success(function(data) {
  ...
  $scope.modal_cotizacion_sitio_eliminar = function(id_cotizacion_sitio){
    var http_request = {
    method: 'GET',
    url: global_apiserver + "/cotizacion_sitios_cil/delete/?id="+id_cotizacion_sitio,
    };
  ...
  $scope.actualiza_sitio_seleccionado = function(id_sitio){
    var http_request = {
      method: 'GET',
      url: global_apiserver + "/cotizacion_sitios_cil/updateSeleccionado/?id="+id_sitio,
    };
